...
namespace WebApplication1.Controllers
{
    ...
    public class WorkersController : ControllerBase
    {
        ...
        public WorkersController(WebApplication1Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Worker>> PostWorker(Worker worker)
        {
            ...
            return CreatedAtAction("GetWorker", new { id = worker.phone }, worker);
        }
        ...
        {
            return _context.Worker.Any(e => e.phone == id);
        }
    }
}
